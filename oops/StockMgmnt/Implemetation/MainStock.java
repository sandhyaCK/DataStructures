...
public class MainStock {
	static StockOperation accountService = new MainOperationOfStock();
...
static Scanner sc = new Scanner(System.in);
	...
	public static void menu() {
		...
		String choice = sc.next();
			...
			switch (choice) {
			case "1":
				StockDetails companyDetails = StockUserDetails. companyDetails(); 
				file = new File("/home/user/git/Oops/StockManagement/src/jsonStock/CompanyList.json");
				accountService.AddDetails(file,companyDetails);
				menu();
				break;
			case "2":
				System.out.println("Enter Company Symbol");
				String symbol = sc.next();
				accountService.RemoveDetails(symbol);
				menu();
				break;
			case "3":
	...
	private static void createAccount(String fileName) {
		...
		file = new File("/home/user/Oops/StockManagement/src/jsonStock/"+fileName+".json");
